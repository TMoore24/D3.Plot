...
function fetchData(startDate,endDate,siteId) {
    ...
    return new Promise(function(resolve,reject){
        ...
        postData.append('tbl','RelativeHumidity'); // <----- change this to change the targeted table
