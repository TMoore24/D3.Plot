...
function fetchData(startDate,endDate,siteId) {
    ...
    return new Promise(function(resolve,reject){
        ...
        postData.append('tbl','Wind_WindDirection'); // <----- change this to change the targeted table
...
////current parameter to display
 ////current parameter to display
 var now= String(wind[wind.length-1]);
var noww= 'Current Wind Speed: '+ now.substr(0,4)+' m/s';
var nowg= String(windg[windg.length-1]);
var nowwg= 'Current Wind Gusts: '+ nowg.substr(0,4)+' m/s';
